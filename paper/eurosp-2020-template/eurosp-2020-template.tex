...
\title{Example submission for Euro S\&P 2020*\\ {\footnotesize
    \textsuperscript{*}Note: Sub-titles are not captured in Xplore and
    should not be used} \thanks{NB: appendices, if any, did
    not benefit from peer review.\newline A preprint of this paper has been
    deposited on ArXiv.}  }
