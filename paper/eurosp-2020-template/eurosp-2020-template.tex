...
As an example, we have proved that both versions of the program, when starting in a state with $A = 1$ and $B = 2$, evaluate to the same final state with $RETURN = 12$. 
